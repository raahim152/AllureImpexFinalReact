...
useEffect(() => {
  ...
  // Recent Orders Data
  const recentOrders = [
    { id: 'ORD-2847', product: 'Corrugated Boxes', amount: '11,240 Pkr', status: 'completed' },
    { id: 'ORD-2846', product: 'Flexible Packaging', amount: '23,000 Pkr', status: 'processing' },
    { id: 'ORD-2845', product: 'Paper Core Tubes', amount: '21,520 Pkr', status: 'pending' },
    { id: 'ORD-2844', product: 'Biomass Pellets', amount: '33,420 Pkr', status: 'completed' }
  ];

  // Recent Activities
  const recentActivities = [
    { type: 'order', title: 'New order received', description: 'Order #ORD-2847 for 12,440 Pkr', time: '2 hours ago' },
    { type: 'customer', title: 'New customer registered', description: 'Global Packaging Solutions', time: '5 hours ago' },
    { type: 'message', title: 'New message received', description: 'From Tech Industries Ltd.', time: '1 day ago' },
    { type: 'inventory', title: 'Product inventory updated', description: 'Corrugated packaging stock', time: '2 days ago' }
  ];
        ...
        <div className="flex-1 overflow-y-auto py-4">
          <nav className="space-y-1 px-4">
            ...
            >
              ...
              <span className="ml-auto bg-primary-500 text-white text-xs px-2 py-1 rounded-full">12</span>
            </button>
                    ...
                    {recentOrders.map((order, index) => (
                      <div key={index} className="flex items-center justify-between p-4 bg-secondary-50 rounded-lg">
                        <div>
                          ...
                          <p className="text-sm text-secondary-500">{order.product}</p>
                        </div>
                        <div className="text-right">
                          <p className="font-medium text-secondary-900">{order.amount}</p>
    ...
    <div className="mt-6">
      ...
      <div className="grid grid-cols-3 md:grid-cols-5 gap-3">
        {newProduct.images.map((image, index) => (
          ...
          {activeTab === 'orders' && (
            <div className="bg-white rounded-2xl shadow-md border border-secondary-100 p-6">
              <h2 className="text-2xl font-bold text-secondary-900 mb-4">Orders Management</h2>
              <p className="text-secondary-600">Order management system will be implemented here.</p>
            </div>
          )}
    ...
    <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <div className="bg-purple-50 rounded-lg p-4">
        ...
        <p className="text-2xl font-bold">
          ...
          {activeTab === 'messages' && (
            <div className="bg-white rounded-2xl shadow-md border border-secondary-100 p-6">
              <h2 className="text-2xl font-bold text-secondary-900 mb-4">Messages & Inquiries</h2>
              <p className="text-secondary-600">Message management system will be implemented here.</p>
            </div>
          )}

          {activeTab === 'analytics' && (
            <div className="bg-white rounded-2xl shadow-md border border-secondary-100 p-6">
              <h2 className="text-2xl font-bold text-secondary-900 mb-4">Analytics Dashboard</h2>
              <p className="text-secondary-600">Analytics and reporting will be implemented here.</p>
            </div>
          )}

          {activeTab === 'settings' && (
            <div className="bg-white rounded-2xl shadow-md border border-secondary-100 p-6">
              <h2 className="text-2xl font-bold text-secondary-900 mb-4">System Settings</h2>
              <p className="text-secondary-600">System configuration will be implemented here.</p>
            </div>
          )}
        </main>
      </div>
